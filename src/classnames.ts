...
const ChapterIconContainer = {
  ...
  iconContainerSmall: 'ChapterIconContainer-iconContainerSmall',
  iconContainerLarge: 'ChapterIconContainer-iconContainerLarge',
...
const Page = {
  ...
  mobileCenterText: 'Page-mobileCenterText',
};
